...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::apiResource('project-ideas', ProjectIdeaController::class)
        ->parameters(['project-ideas' => 'projectIdea'])
    ...
    Route::middleware('role:Supervisor')->group(function (): void {
        ...
        Route::get('supervisor/approved-proposals', [ProjectProposalController::class, 'approvedProposals']);
        ...
        Route::prefix('supervisor')->group(function (): void {
            Route::get('proposals/{proposal}/tasks', [SupervisorTaskReviewController::class, 'index']);
    ...
    Route::middleware('role:CommitteeMember')->group(function (): void {
        ...
        Route::get('final-submissions/{finalSubmission}', [FinalSubmissionController::class, 'show']);
        Route::post('final-submissions/{finalSubmission}/grade', [FinalSubmissionController::class, 'grade']);
    });

    Route::get('project-teams/{projectTeam}/meetings', [MeetingController::class, 'index']);
    Route::post('meetings', [MeetingController::class, 'store']);
    Route::get('meetings/{meeting}', [MeetingController::class, 'show']);

    Route::middleware('role:Student')->group(function (): void {
        Route::get('student/final-submission', [FinalSubmissionController::class, 'showForStudent']);
    });
});